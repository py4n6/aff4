...
func_return = (pyRDFValue *)PyObject_New(pyRDFValue, &RDFValue_Type);
func_return->base = ((XSDString)self->base)->set(((XSDString)self->base), string, length);
...
if(!PyArg_ParseTupleAndKeywords(args, kwds, "OK", kwlist, &urn,&mode))
 return -1;
...
func_return = (pyAFFObject *)PyObject_New(pyAFFObject, &AFFObject_Type);
func_return->base = ((AFFObject)self->base)->finish(((AFFObject)self->base));
talloc_increase_ref_count(func_return->base);
py_result = (PyObject *)func_return;
returned_result = py_result;
return returned_result;
...
func_return = (pyRDFValue *)PyObject_New(pyRDFValue, &RDFValue_Type);
func_return->base = ((XSDDatetime)self->base)->set(((XSDDatetime)self->base), time);
talloc_increase_ref_count(func_return->base);
py_result = (PyObject *)func_return;
returned_result = py_result;
return returned_result;
...
if(!PyArg_ParseTupleAndKeywords(args, kwds, "OK", kwlist, &uri,&mode))
 return NULL;


func_return = (pyAFFObject *)PyObject_New(pyAFFObject, &AFFObject_Type);
func_return->base = ((Resolver)self->base)->open(((Resolver)self->base), uri->base, mode);
talloc_increase_ref_count(func_return->base);
py_result = (PyObject *)func_return;
returned_result = py_result;
return returned_result;
...
func_return = (pyAFFObject *)PyObject_New(pyAFFObject, &AFFObject_Type);
func_return->base = ((Resolver)self->base)->create(((Resolver)self->base), name, mode);
talloc_increase_ref_count(func_return->base);
py_result = (PyObject *)func_return;
returned_result = py_result;
return returned_result;
...
func_return = (pyRDFValue *)PyObject_New(pyRDFValue, &RDFValue_Type);
func_return->base = ((Resolver)self->base)->iter_next_alloc(((Resolver)self->base), iter->base);
talloc_increase_ref_count(func_return->base);
py_result = (PyObject *)func_return;
returned_result = py_result;
return returned_result;
...
/********************************************************
Autogenerated wrapper for function:
uint64_t  FileBackedObject.read(char * buffer; unsigned long int length;
);
********************************************************/
static PyObject *pyFileBackedObject_read(pyFileBackedObject *self, PyObject *args, PyObject *kwds) {
PyObject *returned_result, *py_result;
...
if(!PyArg_ParseTupleAndKeywords(args, kwds, "OK", kwlist, &fileurn,&mode))
 return NULL;


func_return = (pyFileBackedObject *)PyObject_New(pyFileBackedObject, &FileBackedObject_Type);
func_return->base = ((FileBackedObject)self->base)->Con(((FileBackedObject)self->base), fileurn->base, mode);
talloc_increase_ref_count(func_return->base);
py_result = (PyObject *)func_return;
returned_result = py_result;
return returned_result;
...
/********************************************************
Autogenerated wrapper for function:
uint64_t  FileLikeObject.read(char * buffer; unsigned long int length;
);
********************************************************/
static PyObject *pyFileLikeObject_read(pyFileLikeObject *self, PyObject *args, PyObject *kwds) {
PyObject *returned_result, *py_result;
...
func_return = (pyRDFValue *)PyObject_New(pyRDFValue, &RDFValue_Type);
func_return->base = ((XSDInteger)self->base)->set(((XSDInteger)self->base), value);
talloc_increase_ref_count(func_return->base);
py_result = (PyObject *)func_return;
returned_result = py_result;
return returned_result;
...
func_return = (pyRDFValue *)PyObject_New(pyRDFValue, &RDFValue_Type);
func_return->base = ((RDFURN)self->base)->set(((RDFURN)self->base), urn);
talloc_increase_ref_count(func_return->base);
py_result = (PyObject *)func_return;
returned_result = py_result;
return returned_result;
...
func_return = (pyRDFURN *)PyObject_New(pyRDFURN, &RDFURN_Type);
func_return->base = ((RDFURN)self->base)->copy(((RDFURN)self->base), NULL);
talloc_increase_ref_count(func_return->base);
py_result = (PyObject *)func_return;
returned_result = py_result;
return returned_result;
