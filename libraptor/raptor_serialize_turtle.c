...
raptor_turtle_emit(raptor_serializer *serializer)
{
  ...
  /** Create a new tree. This flushes the existing tree and ensures
      we start again. This is done for speed - when we know there are
      no more repeated statements we just start again.
  */
  if(context->subjects) {
